...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
    	...
    	// BedWarsXray
    	if (BedWarsXray.enabled) {
    	    if (Paradox.instance.settingsManager.getSettingByName("Bed").getValBoolean() && this == Block.getBlockById(26)) // bed
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Wool").getValBoolean() && this == Block.getBlockById(35)) // wool
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Glass").getValBoolean() && this == Block.getBlockById(95)) // glass
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Clay").getValBoolean() && this == Block.getBlockById(159)) // stained glass pane
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Ladder").getValBoolean() && this == Block.getBlockById(121)) // ladder
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Oak").getValBoolean() && this == Block.getBlockById(5)) // oak
    	        return true;
    	    if (Paradox.instance.settingsManager.getSettingByName("Obsidian").getValBoolean() && this == Block.getBlockById(49)) // obsidian
    	        return true;
    	    	if (BedWarsXray.enabled)
    	    		return false;
