package me.gamrboy4life.paradox.devlogs.cosmetic.impl;


import me.gamrboy4life.paradox.devlogs.cosmetic.CosmeticBoolean;
import me.gamrboy4life.paradox.utils.animation.AnimatedResourceLocation;
...
public class CosmeticSnowyCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    static {
        CosmeticSnowyCape.CAPEANIMATED = new AnimatedResourceLocation("cape/capenow", 24,24);
    }
